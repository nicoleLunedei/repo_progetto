...
#include "equation.hpp"
 ...
 //////////////////////Parametric////////////////////////////// 
Equation::Equation(std::vector<People>& population,  Parameters& par,const int& N):  Pandemic(population,par,N){}

/////////////////////////Default////////////////////////////
Equation::Equation(): Pandemic(){
      /////////////////Creates an object equal to Pandemic, but setting an initial situation/////////////////
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||//
   ...
   const People Equation::fix(std::array<double,6> next){
     ...
     assert(diff >= 0);
     /////////////////////Searching for the double number with the greatest decimal part///////////////////////////// 
     if (0 < diff && diff < 2)
      {
