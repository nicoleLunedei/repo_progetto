...
///////////////////////////////////////Pandemic Class///////////////////////////////////
  ////////////////////////Constructors////////////////////////////
    ...
    ////////////////Default //////////////////
     ...
     ////////////////Copy/////////////////////////
    Pandemic::Pandemic(Pandemic& copy):  par_(copy.get_Parameters()) , N_{copy.get_number_population()}{
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   People&  Pandemic::get_situation_day( const int& i){
      ...
      return this->get_evolution()[static_cast<std::vector<People>::size_type>(i - 1)];
     }
     ...
     long unsigned int Pandemic::get_days() const {
      ...
      const int& Pandemic::get_number_population() const
    { 
      return this->N_;
    }
    ...
    if (com > 1){
     ...
     bool Pandemic::check_R0(Parameters& p){
      if (this->calculate_R0(p) > 1){
        ...
        throw std::runtime_error{"The simulation can't start if the critical threshold is minor than or equal to one! "};
      }
    }
...
void  Pandemic::add_data(const People& add){
    assert((sum(transform_Array<int,6>(add))) == (this->get_number_population()));
