  ...
  SUBCASE("Contructors") {
    ...
    SUBCASE("Parametric") {
     ...
     ////////////Creating an Equation object with the parametric Constructor//////////////// 
      std::unique_ptr<Equation> eq1 = std::make_unique<Equation>(days, p, 600000);
 ...
 //////////////Adding data/////////////////
    ...
    std::unique_ptr<Equation> eq2 = std::make_unique<Equation>(days, pp, 600);
      ...
      eq2->add_data(eq2->fix(situation2));
       ...
       CHECK(sum(transform_Array<int,6>(eq2->get_situation_day(2))) == eq2->get_number_population());
...
///////////////////////////////////#2///////////////////////////////////////
     ...
     eq2->add_data(eq2->fix(situation3));
       ...
       CHECK(sum(transform_Array<int,6>(eq2->get_situation_day(3))) == eq2->get_number_population());
...
////////////////////////////////#3//////////////////////////////////
  std::array<double,6> situation4 = eq2->update_situation(0,c);
      ...
      eq2->add_data(eq2->fix(situation4));
       ...
       CHECK(sum(transform_Array<int,6>(eq2->get_situation_day(4))) == eq2->get_number_population());
      /////////////////////////evolve()/////////////////
      eq2->evolve();
     ...
     ////////////////////Introducing the option of the vaccine//////////////////
      ...
      /////////sorting => is _vaccinated///////////
       ...
       CHECK(eq2->get_days() == 5);
       CHECK(static_cast<double>(eq2->get_situation_day(5).S_[0])/(sum(eq2->get_situation_day(5).S_)) == doctest::Approx(0.76).epsilon(0.1));
       CHECK(static_cast<double>(eq2->get_situation_day(5).S_[1])/(sum(eq2->get_situation_day(5).S_))  == doctest::Approx(0.24).epsilon(0.1));
       CHECK(eq2->get_situation_day(5).I_[0] == 41);
       CHECK(eq2->get_situation_day(5).I_[1] == 0);
       CHECK(eq2->get_situation_day(5).H_ == 38);
       CHECK(eq2->get_situation_day(5).D_ == 69);

       CHECK(sum(transform_Array<int,6>((eq2->get_evolution()).back())) == eq2->get_number_population());
