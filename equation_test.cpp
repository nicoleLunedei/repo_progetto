 ...
 //////////////Adding data/////////////////
    ...
    Equation eq2(days, pp, 600);
      ...
      eq2.add_data(eq2.fix(situation2));
       ...
       CHECK(sum(transform_arr<int,6>(eq2.get_situation_day(2))) == eq2.get_number_population());
...
///////////////////////////////////#2///////////////////////////////////////
     ...
     eq2.add_data(eq2.fix(situation3));
       ...
       CHECK(sum(transform_arr<int,6>(eq2.get_situation_day(3))) == eq2.get_number_population());
...
////////////////////////////////#3//////////////////////////////////
  std::array<double,6> situation4 = eq2.update_situation(0,c);
      ...
      eq2.add_data(eq2.fix(situation4));
       ...
       CHECK(sum(transform_arr<int,6>(eq2.get_situation_day(4))) == eq2.get_number_population());
      /////////////////////////evolve()/////////////////
      eq2.evolve();
